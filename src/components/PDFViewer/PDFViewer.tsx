...
const PDFViewer: React.FC<PDFViewerProps> = (props) => {
    ...
    const visibleItems = [...[{ _pageIndex: -1 }, ...pages], ...[{ _pageIndex: -1 }, ...pages]].slice(
        indexInArrayScope,
        indexInArrayScope + 3
    );
    ...
    return (
        <motion.div initial="initial" animate="initial" whileHover={'hover'} className={styles.pdfWrapper}>
            <div className={styles.pdfContent}>{renderPages}</div>
